...
class Dataset:
    ...
    def __init__(self, conf):
        ...
        if self.use_normal:
            ...
            normals_np = []
            img_ext='.npz'
            if conf["normal_type"] == "npy":
                img_ext='.npy'
                normals_npz, stems_normal = read_images_modified(f'{self.data_dir}/pred_normal', target_img_size=(w_img, h_img), img_ext=img_ext)
            else:
                normals_npz, stems_normal = read_images(f'{self.data_dir}/pred_normal', target_img_size=(w_img, h_img), img_ext=img_ext)
